  ...
  <div class="new-main">
    ...
    <div class="tab-contents new-main-intro" id="intro">
      ...
      >
        ...
        <div
          ...
          data-aos-delay="200"
        >
          <div class="new-main-intro-login-form">
            <form action="">
              <div class="new-main-intro-login-form__title">
                회원님의 정보를 확인하세요!
              </div>
              <div class="new-main-intro-login-form__form">
                <div class="c-form-group">
                  <label for="" class="c-form-label c-dpN">아이디</label>
                  <input type="text" title="아이디" placeholder="아이디" />
                </div>
                <div class="c-form-group">
                  <label for="" class="c-form-label c-dpN">비밀번호</label>
                  <input
                    type="password"
                    title="비밀번호"
                    placeholder="비밀번호"
              ...
              <div class="new-main-intro-login-form__link">
                <ul>
                  <li><a href="">아이디 찾기</a></li>
                  <li><a href="">비빌번호 찾기</a></li>
                  <li><a href="">회원가입</a></li>
                </ul>
              </div>
              <div class="new-main-intro-login-form__sns">
                <strong>소셜미디어 로그인</strong>
                <p>
                  <a href="" class="new-main-intro-login-form__sns-naver">
                    네이버
                  </a>
                  <a href="" class="new-main-intro-login-form__sns-kakao">
                    카카오
                  </a>
                </p>
              </div>
    ...
    <div class="tab-contents new-main-mentoring" id="Mentoring">
      <div class="new-main__inner">
        ...
        <div
          class="new-main-mentoring__group"
          data-scroll
          data-scroll-speed="0.2"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          <div class="new-main-mentoring__img">
            <img src="@img/main/pic-main-mentoring-img.svg" alt="이미지" />
          </div>
          <div class="new-main-mentoring__item">
            <div class="c-message c-message-left">
              <p>
                서울대 합격했어요!<br />
                함께 공부하는 감사함, 즐거움을<br />
                일깨워주는 시간이었습니다.<br />
            ...
            <dl class="new-main-user">
              <dt>
                <img src="@img/main/pic-main-profile01.svg" alt="이미지" />
              </dt>
              <dd>
                <span class="c-badge c-badge-lg c-badge-black">열공멘티</span>
                <p>고등학교 3학년 김*성</p>
              </dd>
            </dl>
          </div>
          <div class="new-main-mentoring__item">
            <div class="c-message c-message-right">
              <p>
                같은 고민을 했던 선배로서<br />
                시행착오를 줄일 수 있게<br />
                도와주고 싶었어요.<br />
            ...
            <dl class="new-main-user">
              <dt>
                <img src="@img/main/pic-main-profile02.svg" alt="이미지" />
              </dt>
              <dd>
                <span class="c-badge c-badge-lg c-badge-black">열혈멘토</span>
                <p>고려대학교 재학중 강*민</p>
              </dd>
            </dl>
          </div>
