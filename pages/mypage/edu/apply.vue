...
const {
  MENTORING: { MENTORING_EDU_INFO },
} = useAppConfig();

const segment = 'apply';  // 멘토교육
              ...
              <dl>
                ...
                <dd v-show="gridVisible.pre == true">
                  <div class="mypage-edu__contents">
                    <EduLectureTable v-model="eduData.preEduDetails" :segment="segment" />
                  </div>
                </dd>
              </dl>
              <dl>
                ...
                <dd v-show="gridVisible.ot == true">
                  <div class="mypage-edu__contents">
                    <EduLectureTable v-model="eduData.otEduDetails" :segment="segment" />
                  </div>
                </dd>
              </dl>
              <dl>
                ...
                <dd v-show="gridVisible.reg == true">
                  <div class="mypage-edu__contents">
                    <EduLectureTable v-model="eduData.regularEduDetails" :segment="segment" />
                  </div>
                </dd>
              </dl>
            </div>
            <div class="c-btn-group">
              <button class="c-btn c-btn-lg c-btn-danger" @click="router.push('/mypage/edu/ing')">
                수강 중 교육 바로가기
              </button>
            </div>
          </div>
